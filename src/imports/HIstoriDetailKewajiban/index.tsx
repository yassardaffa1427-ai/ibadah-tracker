import svgPaths from "./svg-hmagkbmvy9";
...
function Frame() {
  return (
    <div className="bg-[#31b98b] content-stretch flex flex-[1_0_0] items-center justify-center min-w-px px-[24px] py-[8px] relative rounded-[110px]">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#f6fcf9] text-[14px] text-center whitespace-nowrap">Daily Kewajiban</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-w-px px-[24px] py-[8px] relative rounded-[110px]">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#85938e] text-[14px] text-center whitespace-nowrap">Daily Sunnah</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[#eab308] text-[0px] text-right whitespace-nowrap">
        <span className="leading-[30px] text-[#2e9973] text-[30px]">2</span>
        <span className="leading-[28px] text-[#65726d] text-[18px]">/11</span>
      </p>
    </div>
  );
}
...
function Container7() {
  return <div className="bg-gradient-to-r from-[#beeb77] h-[9.983px] relative rounded-[39407900px] shrink-0 to-[#31b98b] w-[57.438px]" data-name="Container" />;
}

function Container6() {
  return (
    <div className="bg-[#edf8f3] content-stretch flex flex-col h-[9.983px] items-start overflow-clip relative rounded-[39407900px] shrink-0 w-[319.156px]" data-name="Container">
      <Container7 />
    </div>
  );
}
...
function Text() {
  return (
    <div className="bg-[rgba(88,204,2,0.12)] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[39407900px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#31b98b] text-[12px] whitespace-nowrap">2 selesai</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="bg-[#edf8f3] content-stretch flex flex-col items-start px-[10px] py-[4px] relative rounded-[39407900px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#65726d] text-[12px] whitespace-nowrap">7 terlewat</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex gap-[8px] h-[40px] items-start pt-[16px] relative shrink-0 w-[319.156px]" data-name="Container">
      <Text />
      <Text1 />
    </div>
  );
...
function Container2() {
  return (
    <div className="bg-white border-[#d2eee1] border-[1.174px] border-solid content-stretch flex flex-col items-start p-[20px] relative rounded-[16px] shadow-[0px_1px_0px_0px_#d2eee1,0px_2px_10px_0px_rgba(31,59,40,0.05)] shrink-0 w-full" data-name="Container">
      <Container3 />
      <ContainerMargin />
      <Container8 />
    </div>
...
function Container12() {
  return (
    <div className="bg-[#edf8f3] content-stretch flex items-center justify-center relative rounded-[8px] shrink-0 size-[23.984px]" data-name="Container">
      <Icon1 />
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Tahajud</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="bg-white border-[#d2eee1] border-[1.174px] border-solid content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-[16px] shadow-[0px_1px_0px_0px_#d2eee1,0px_2px_10px_0px_rgba(31,59,40,0.05)] shrink-0 w-full" data-name="Container">
      <Container11 />
    </div>
  );
}
...
function Container16() {
  return (
    <div className="bg-[#31b98b] content-stretch flex items-center justify-center relative rounded-[8px] shrink-0 size-[23.984px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Subuh</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="bg-[rgba(88,204,2,0.07)] border-[#81d0af] border-[1.174px] border-solid content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-[16px] shadow-[0px_1px_0px_0px_#d2eee1,0px_2px_10px_0px_rgba(31,59,40,0.05)] shrink-0 w-full" data-name="Container">
      <Container15 />
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Dhuha</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Zuhur</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Ashar</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Maghrib</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Isya</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Kajian</p>
    </div>
  );
}
...
function Paragraph19() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Murojaah Hafalan</p>
    </div>
  );
}
...
function Paragraph21() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Zikir Pagi</p>
    </div>
  );
}
...
function Paragraph23() {
  return (
    <div className="content-stretch flex flex-col h-[20.002px] items-start overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#65726d] text-[14px] whitespace-nowrap">Zikir Petang</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col h-[785.863px] items-start pt-[20px] relative shrink-0 w-[361.473px]" data-name="Container">
      <Container10 />
      <ContainerMargin1 />
      <ContainerMargin2 />
      <ContainerMargin3 />
...
function DayRecapDetail() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[361.473px]" data-name="DayRecapDetail">
      <Container2 />
      <Container9 />
    </div>
  );
...
function HistoryPage() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[672px] px-[16px] py-[24px] relative shrink-0 w-full" data-name="HistoryPage">
      <Container />
      <Container1 />
      <DayRecapDetail />
    </div>
...
function MainContent() {
  return (
    <div className="bg-[#f6fcf9] content-stretch flex flex-col h-[1133.672px] items-start min-h-[851.4739990234375px] overflow-clip pb-[80px] relative shrink-0 w-[393.44px]" data-name="Main Content">
      <HistoryPage />
    </div>
  );
}
...
function SettingsIcon() {
  return (
    <div className="relative shrink-0 size-[21.984px]" data-name="SettingsIcon">
      <svg className="absolute block inset-0 size-full" fill="none" height="21.9842" preserveAspectRatio="none" viewBox="0 0 21.9842 21.9842" width="21.9842">
        <g clipPath="url(#clip0_0_7)" id="SettingsIcon">
...
function BottomNav() {
  return (
    <div className="absolute bg-white border-[#d2eee1] border-solid border-t-[1.174px] bottom-[-0.16px] content-stretch flex items-start left-0 w-[393.44px]" data-name="BottomNav">
      <ButtonDashboard />
      <ButtonChecklist />
      <ButtonHistori />
      <ButtonSettings />
...
export default function HIstoriDetailKewajiban() {
  return (
    <div className="bg-[#f6fcf9] content-stretch flex flex-col items-start relative size-full" data-name="HIstori detail - kewajiban">
      <MainContent />
      <BottomNav />
    </div>
  );
