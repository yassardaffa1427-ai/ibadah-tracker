import svgPaths from "./svg-rth94zdoa7";
import imgAvatarImage from "./822e5ce6ff0297d1d4ac74c67a7b6a951f81caeb.png";
...
function AvatarImage() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="AvatarImage">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAvatarImage} />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="bg-[#e9f3e3] relative rounded-[33554400px] shrink-0 size-[32px]" data-name="Container">
...
function Heading1() {
  return (
    <div className="h-[36px] relative shrink-0 w-[157.422px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[4px] relative size-full">
        <p className="[word-break:break-word] font-['DM_Serif_Display:Regular',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1f3b28] text-[24px] whitespace-nowrap">Ibadah Hari Ini</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="relative shrink-0 w-[157.422px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph2 />
        <Heading1 />
      </div>
  ...
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[33px] relative shrink-0 text-[#6b7280] text-[22px] text-right whitespace-nowrap">0</p>
      </div>
    </div>
  );
}
...
function StreakBadge1() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[38.03px] top-0" data-name="StreakBadge">
      <Icon1 />
      <Text1 />
    </div>
  );
...
function Paragraph3() {
  return (
    <div className="h-[18px] relative shrink-0 w-[97.016px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end pt-[2px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#6d8a76] text-[12px] text-right whitespace-nowrap">Terpanjang: 5 hari</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="relative shrink-0 w-[97.016px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Container9 />
        <Paragraph3 />
      </div>
...
function Text2() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#6d8a76] text-[14px] whitespace-nowrap">0 dari 9 selesai</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['DM_Serif_Display:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#e8b02a] text-[20px] whitespace-nowrap">0%</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return <div className="bg-gradient-to-r from-[#99dd6a] h-[6px] relative shrink-0 to-[#6cc02e] w-0" data-name="Container" />;
}
  ...
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Ashar</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Dhuha</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Isya</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Maghrib</p>
      </div>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Murojaah Hafalan</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Subuh</p>
      </div>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="bg-[rgba(239,68,68,0.1)] relative rounded-[33554400px] shrink-0" data-name="Text">
      <div aria-hidden className="absolute border border-[rgba(239,68,68,0.2)] border-solid inset-0 pointer-events-none rounded-[33554400px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[9px] py-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#e04a3f] text-[12px] whitespace-nowrap">Zuhur</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[105px] relative shrink-0 w-[795px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="105" preserveAspectRatio="none" viewBox="0 0 795 105" width="795">
        <g id="Icon">
          <path d={svgPaths.p37491300} fill="#EAF1E5" id="Vector" />
          ...
          <path d={svgPaths.p40cb00} fill="#58A700" id="Vector_338" />
          <path d={svgPaths.p349bb780} fill="#6CC02E" id="Vector_339" />
          <path d={svgPaths.p7e8d8f0} fill="#99DD6A" id="Vector_340" />
          <path d={svgPaths.p2c2d2d80} fill="#58A700" id="Vector_341" />
          <path d={svgPaths.p2ba0b700} fill="#6CC02E" id="Vector_342" />
          <path d={svgPaths.p25b15c60} fill="#6CC02E" id="Vector_343" />
          <path d={svgPaths.p38519d00} fill="#58A700" id="Vector_344" />
          <path d={svgPaths.p3bb95700} fill="#58A700" id="Vector_345" />
          <path d={svgPaths.p5194200} fill="#99DD6A" id="Vector_346" />
          <path d={svgPaths.p3aab7c00} fill="#6CC02E" id="Vector_347" />
          <path d={svgPaths.p3ca60780} fill="#58A700" id="Vector_348" />
          <path d={svgPaths.p19179800} fill="#6CC02E" id="Vector_349" />
          <path d={svgPaths.p1374a680} fill="#58A700" id="Vector_350" />
          <path d={svgPaths.p9e42f00} fill="#99DD6A" id="Vector_351" />
          <path d={svgPaths.p19c41280} fill="#6CC02E" id="Vector_352" />
          <path d={svgPaths.p15b3e400} fill="#58A700" id="Vector_353" />
          <path d={svgPaths.p1bdf0400} fill="#58A700" id="Vector_354" />
          <path d={svgPaths.p27033b80} fill="#6CC02E" id="Vector_355" />
          <path d={svgPaths.p39037e80} fill="#6CC02E" id="Vector_356" />
          <path d={svgPaths.p382b3400} fill="#58A700" id="Vector_357" />
          <path d={svgPaths.p138d9d80} fill="#58A700" id="Vector_358" />
          <path d={svgPaths.p3f2f300} fill="#58A700" id="Vector_359" />
          <path d={svgPaths.p367680} fill="#6CC02E" id="Vector_360" />
          <path d={svgPaths.p11fe0980} fill="#99DD6A" id="Vector_361" />
          <path d={svgPaths.p3f804680} fill="#58A700" id="Vector_362" />
          <path d={svgPaths.p25c11980} fill="#6CC02E" id="Vector_363" />
          <path d={svgPaths.p3acc1e80} fill="#58A700" id="Vector_364" />
          <path d={svgPaths.p13f2f100} fill="#58A700" id="Vector_365" />
          <path d={svgPaths.p3824b100} fill="#EAF1E5" id="Vector_366" />
        </g>
      </svg>
    </div>
  );
...
function Text15() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#6d8a76] text-[14px] whitespace-nowrap">3</p>
      </div>
    </div>
  );
}
...
function Container90() {
  return <div className="bg-[#6d8a76] h-[6px] relative shrink-0 w-0" data-name="Container" />;
}
...
function Text16() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[20px] relative shrink-0 text-[#6d8a76] text-[14px] whitespace-nowrap">0/9</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="relative shrink-0 w-[734px]" data-name="Button">
...
function Text17() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#58a700] text-[14px] whitespace-nowrap">2</p>
      </div>
    </div>
  );
}
...
function Container91() {
  return (
    <div className="bg-[rgba(88,204,2,0.14)] relative rounded-[12px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <Text17 />
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[13.5px] relative shrink-0 text-[#6d8a76] text-[9px] uppercase whitespace-nowrap">Agt</p>
      </div>
...
function Paragraph6() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Minggu</p>
      </div>
    </div>
  );
}
...
function Container94() {
  return <div className="bg-[#58a700] h-[6px] relative rounded-[33554400px] shrink-0 w-full" data-name="Container" />;
}
...
function Text18() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[20px] relative shrink-0 text-[#58a700] text-[14px] whitespace-nowrap">9/9</p>
      </div>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="relative shrink-0 w-[734px]" data-name="Button">
      <div aria-hidden className="absolute border-[#dbe8d2] border-solid border-t inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center pb-[12px] pt-[13px] px-[16px] relative size-full">
        <Container91 />
        <Container92 />
        <Text18 />
        <Icon4 />
...
function Text19() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#58a700] text-[14px] whitespace-nowrap">1</p>
      </div>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Sabtu</p>
      </div>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#6cc02e] text-[14px] whitespace-nowrap">31</p>
      </div>
    </div>
  );
}
...
function Container99() {
  return (
    <div className="bg-[#e9f3e3] relative rounded-[12px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative size-full">
        <Text21 />
        <p className="[word-break:break-word] font-['Outfit:Medium',sans-serif] font-medium leading-[13.5px] relative shrink-0 text-[#6d8a76] text-[9px] uppercase whitespace-nowrap">Jul</p>
      </div>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Jumat</p>
      </div>
    </div>
  );
}
...
function Container102() {
  return <div className="bg-[#6cc02e] h-[6px] relative rounded-[33554400px] shrink-0 w-[523.5px]" data-name="Container" />;
}
...
function Text22() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[20px] relative shrink-0 text-[#6cc02e] text-[14px] whitespace-nowrap">8/9</p>
      </div>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#58a700] text-[14px] whitespace-nowrap">30</p>
      </div>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Kamis</p>
      </div>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#e8b02a] text-[14px] whitespace-nowrap">29</p>
      </div>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Rabu</p>
      </div>
    </div>
  );
}
...
function Container110() {
  return <div className="bg-[#e8b02a] h-[6px] relative rounded-[33554400px] shrink-0 w-[329.391px]" data-name="Container" />;
}
...
function Text26() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[20px] relative shrink-0 text-[#e8b02a] text-[14px] whitespace-nowrap">5/9</p>
      </div>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[14px] relative shrink-0 text-[#6cc02e] text-[14px] whitespace-nowrap">28</p>
      </div>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Outfit:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#1f3b28] text-[14px] whitespace-nowrap">Selasa</p>
      </div>
    </div>
  );
}
...
function RecentHistory() {
  return (
    <div className="bg-white h-[497px] relative rounded-[16px] shrink-0 w-full" data-name="RecentHistory">
...
function Section2() {
  return (
    <div className="h-[549px] relative shrink-0 w-[736px]" data-name="Section">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[24px] relative size-full">
        <Container86 />
        <RecentHistoryMargin />
      </div>
...
function DashboardPage() {
  return (
    <div className="max-w-[768px] relative shrink-0 w-[768px]" data-name="DashboardPage">
...
function AppShell() {
  return (
    <div className="bg-[#f6faf2] h-[1096px] relative shrink-0 w-full" data-name="AppShell">
